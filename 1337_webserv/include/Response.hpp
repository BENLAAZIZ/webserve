...
class Response {
    ...
    public:
        ...
        void        handleGetResponse(int *flag, Request &request, int flag_delete, Server_holder &serv_hldr);
        void        reset();
        std::string	get_status_message(int errorCode) const;
        ...
        ssize_t        send_header_response(std::string path, Request &request, int flag_autoindex, const std::string& headers_cgi);
        ...
        void there_is_error_file(std::string fullPath, int statusCode, int *flag);
