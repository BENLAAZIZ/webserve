...
/*   Updated: 2025/02/16 16:47:16 by hben-laz         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void Server::handleClientData(std::size_t index) {
	...
	while (1)
	{
		...
		if (!requests[client_fd].getMethod().length())
		{
			// Parse request line
			...
			std::cout << "Method: " <<  requests[client_fd].getMethod() << std::endl;
			std::cout << "Path: " <<  requests[client_fd].getpath() << std::endl;
			std::cout << "Version: " <<  requests[client_fd].getVersion() << std::endl;
		std::cout << " ------------------------------------- "<< std::endl;
		}
