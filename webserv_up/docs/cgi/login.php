...
// Store debug info in variables instead of outputting directly
$debug_session_path = session_save_path();
$debug_session_name = session_name();
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($username === 'admin' && $password === '1234') {
        ...
        // Now it's safe to output content
        echo "Session save path: " . $debug_session_path;
        echo "<br>Session name: " . $debug_session_name;
        echo "<h1>Login Successful!</h1>";
        echo "<p>Welcome, " . htmlspecialchars($username) . "!</p>";
        echo "<p><a href='/cgi/dashboard.php'>Go to Dashboard</a></p>";
    } else {
